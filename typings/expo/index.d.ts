// Typings from https://gist.github.com/pierre-H/eef9a9225fb1c5a0f81180a8b0fbb2c2
declare module 'expo' {
    ...
    export namespace Audio {
        ...
        export class Sound {
            ...
            setRateAsync(value: number,
                         shouldCorrectPitch: boolean): Promise<SoundStatus>;
    ...
    export namespace Notifications {
        ...
        export function scheduleLocalNotificationAsync(localNotification: LocalNotification,
                                                       schedulingOptions: { time: Date | number, repeat?: 'minute' | 'hour' | 'day' | 'week' | 'month' | 'year' }): Promise<LocalNotificationId>;
    ...
    export namespace SQLite {
        ...
        export interface Database {
            transaction(callback: (transaction: Transaction) => any,
                        error?: (error: Error) => any,     // TODO def of error
                        success?: () => any): void
        }

        export interface Transaction {
            executeSql(sqlStatement: string,
                       arguments?: Array<string | number>,
                       success?: (transaction: Transaction, resultSet: ResultSet) => any,
                       error?: (transaction: Transaction, error: Error) => any): any
        }
     ...
     * Expo Take Snapshop
     */
    export function takeSnapshotAsync(view?: (number | React.ReactElement<any>),
                                      options?: {
                                          width?: number,
                                          height?: number,
